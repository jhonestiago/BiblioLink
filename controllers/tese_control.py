...
class TeseControl:
    ...
    def consultar_tese(self, indice:int) -> Tese:
        '''
    ...
    def alterar_tese(self, indice:int, tese:Tese) -> str:
        '''
    ...
    @lista_teses.setter
    def lista_teses(self, lista:List[Tese]) -> None:
        pass
