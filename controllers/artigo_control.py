...
class ArtigoControl:
    ...
    def consultar_artigo(self, indice:int) -> Artigo:
        '''
    ...
    def alterar_artigo(self, indice:int, artigo:Artigo) -> str:
        '''
    ...
    def lista_artigos(self, lista:List[Artigo]) -> None:
        pass
